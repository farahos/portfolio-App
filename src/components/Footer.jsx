...
const Footer = () => {
    ...
    const socialLinks = [
        ...
        {
            name: "LinkedIn",
            url: "https://www.linkedin.com/in/abdullahi-abdirzak-hassan-1918b431b?utm_source=share_via&utm_content=profile&utm_medium=member_android",
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: "YouTube",
            url: "https://youtube.com/@engfarahoz?si=BpXWWCyuPZRuYucE",
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
